...
public class TestVrpSolution {

	private List<List<Integer>> routes; 
	private List<Integer> unrouted;  
	private TestVrpProblem problem;

	public TestVrpSolution(List<List<Integer>> routes, TestVrpProblem problem) {
		this.routes = routes;
		this.problem = problem;
	}

	public TestVrpSolution(List<List<Integer>> routes, List<Integer> removedCustomers, TestVrpProblem problem) {
		this(routes, problem);
		this.unrouted = removedCustomers;
	}
	
	public TestVrpProblem getProblem() {
		return this.problem;
	}
