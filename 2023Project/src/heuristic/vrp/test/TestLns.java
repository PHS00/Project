...
public class TestLns {

	private final Random rand;

	public TestLns(Random rand) {
		this.rand = rand;
	}

	public TestVrpSolution remove(TestVrpSolution sol, int numToRemove) {
		TestVrpProblem problem = sol.getProblem();
		...
		return new TestVrpSolution(newRoutes, removedCustomers, problem);
	}
	...
	public TestVrpSolution repair(TestVrpSolution sol, List<Integer> removedCustomers){
		...
		return new TestVrpSolution(routes, problem);
	}
